...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::chunk::list_active_lexical_chunks,
            commands::chunk::create_manual_lexical_chunk,
            commands::chunk::import_scenario_pack_vocabulary,
            commands::chunk::promote_lexical_chunk,
            commands::chunk::record_lexical_chunk_attempt,
            commands::dictionary::explain_selection,
            commands::dictionary::list_dictionary_entries,
            commands::dictionary::set_dictionary_entry_excluded,
            commands::dictionary::promote_dictionary_entry,
            ...
            commands::reading::submit_reading_comprehension_answer,
            commands::reading::accept_reading_chunks,
            commands::reading::submit_reading_production,
            commands::reading::submit_reading_spoken_response,
            commands::reading::get_reading_session,
